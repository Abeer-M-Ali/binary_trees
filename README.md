...
* **1. Insert left**
  * [1-binary_tree_insert_left](./1-binary_tree_insert_left.c): C function that inserts a
...
* **36. Is Binary heap**
  * [binary_tree_is_heap](./130-binary_tree_is_heap.c): This file function checks if a binary tree is a valid
    * Where `tree` is a pointer to the root node of the `tree` to check
    * Your function must return `1` if `tree` is a valid Max Binary Heap, and `0` otherwise
    * If `tree` is `NULL`, return `0`

* **37. Heap - Insert**
  * [binary_tree_is_heap](./130-binary_tree_is_heap.c): This file function inserts a value in Max Binary Heap
...
* **38. Heap - Array to Binary Heap**
  * [array_to_heap](./132-array_to_heap.c): This file function builds a Max Binary Heap tree from an array
    * Where array is a pointer to the first element of the array to be converted
    * And size is the number of element in the array
    * Your function must return a pointer to the root node of the created Binary Heap, or NULL on failure

* **39. Heap - Extract**
  * [heap_extract](./133-heap_extract.c): This file function extracts the root node of a Max Binary Heap
...
* **40. eap - Sort**
  * [heap_to_sorted_array](./134-heap_to_sorted_array.c): This file function converts a Binary Max Heap to a sorted array of integers
